...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:316px;left:423px;height:auto;"> 
          ...
          <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
            ...
            <div class="x-panel-content" xid="content2">
              <div component="$UI/system/components/justep/list/list" class="x-list"
                xid="list1" data="goodsData" filter=' $row.val("fShopID") == $model.menuData.val("id")'> 
                  ...
                  <li xid="li1" class="text-center tb-listBox text-black"
                    ...
                    <div component="$UI/system/components/justep/row/row" class="x-row"
                      ...
                      <div class="x-col x-col-fixed x-col-center pull-left"
                       ...
                       <!--  --> <img src="" alt="" xid="image2" bind-attr-src=" $model.getImageUrl(val(&quot;fImg&quot;)) "
                          onload="AutoResizeImage(640,400,this)"/>
                      </div>  
                      <div class="x-col" xid="col3">
                        ...
                        <div component="$UI/system/components/justep/row/row"
                          class="x-row" xid="row7"><div class="x-col" xid="col1"></div>
  <div class="x-col x-col-fixed x-col-center" xid="col5" style="width:auto;"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="button" xid="button2" icon="icon-android-remove">
   <i xid="i2" class="icon-android-remove"></i>
   <span xid="span4"></span></a></div>
  <div class="x-col x-col-fixed x-col-center" xid="col7" style="width:auto;"><input component="$UI/system/components/justep/input/input" class="form-control" xid="input4" dataType="Integer" format="0,000" min="0" max="99" maxLength="2" placeHolder="0" style="text-align:center;width:50px;"></input></div>
  <div class="x-col x-col-fixed x-col-center" xid="col8" style="width:auto;"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-sm btn-only-icon" label="button" xid="button1" icon="icon-android-add">
